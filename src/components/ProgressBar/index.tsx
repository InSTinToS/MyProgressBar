  ...
  return (
    <Style>
      <div>
        ...
        <button type='button' onClick={() => setErrorFirst()}>
          FirstError
        </button>

        <button type='button' onClick={() => setErrorSecond()}>
          SecondError
        </button>

        <button type='button' onClick={() => setErrorThird()}>
          ThirdError
        </button>
      </div>
      ...
      >
        <g id='statusBar' filter='url(#barFilter)'>
          ...
          {errorFirst && <path className='errorIcon' id='firstFail' d='M23 41L42 22M42 41L23 22' />}
        ...
        <defs>
          <linearGradient id='barGradient' x1='0%' y1='50%' x2='200%' y2='50%'>
            <motion.stop stopColor='#329dff' animate={{ offset: progressTrue }} />

            <motion.stop stopColor='#c162d2' animate={{ offset: progressFalse }} />
          </linearGradient>
